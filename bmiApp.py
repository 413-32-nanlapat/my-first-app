...
weight = st.number_input("กรอกน้ำหนักของคุณ (กิโลกรัม):", min_valaue=1.0)
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
  if bmi < 18.5:
      ...
      st.success("🎉 คุณมีน้ำหนักเกณฑ์ปกติ (สุขภาพดี)")
  elif 23.0 <= bmi < 25.0:
      st.info("🎉 คุณมีน้ำหนักเกินเกณฑ์ (ท้วม)")
  elif 
      st.error("🎉 คุณมีน้ำหนักเกณฑ์ ควรระวังเรื่องสุขภาพและออกกำลังกาย")

st.divider()
st.writr(นางสาวนันท์ลภัส จำต๊ะ เลขที่ 31 ม.4/13")
